...
class InfiniteGMMGibbsSampler():
    def __init__(self, X, K, burn_in=0, iterations=40, **kwargs):
        ...
        self.alpha0 = 1000 # Uniform prior
        ...
        if np.isnan(self.m0).any():
            print('nan')
        self.V0 = np.eye(self.D) * 100     # D x D
        # Sigma
    ...
    def niw_mc_estimate(self, x, n_mce=100, m=None, v=None, nu=None, s=None,random_k=None):
    ...
    def fit(self):
        ...
        for it in range(self.iterations):
            ...
            if it%5 == 0 or it==0:
                ...
                plot_hmm_data(self.X, bgmm.predict(self.X), self.K, self.mu, self.sigma)
